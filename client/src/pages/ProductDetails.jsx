        ...
        <div className="mt-10">
            ...
            <div className='flex flex-col items-center mt-20'>
                    <div className='flex flex-col items-center w-max'>
                        ...
                        <div className='w-20 h-0.5 bg-gray-400 rounded-full mt-3'> 
                    ...
                    <button onClick={()=>{navigate('/products'); scrollTo(0,0)}} className='mx-auto cursor-pointer px-12 my-16 py-2.5 border rounded transition'>See More</button>
            </div>
        </div>
    );
};
